var luong;
try {
    luong = JSON.parse($response.body) ?? {};
} catch (e) {
    luong = {}; 
}
...
if ($request.url.indexOf(vipa) != -1) {
    luong.data["psnl_vip_property"] = vip;
    luong.data["fax_balance"] = "99999";
    luong.data["used_points"] = "99999";
    luong.data["points"] = "99999";
    luong.data["pdfword_balance"] = "100010";
    luong.data["bookmode_balance"] = 100010;
    luong.data["immt_expy_points"] = "99999";
    luong.data["ocr_balance"] = 99999;
    luong.data["no_login_ocr_balance"] = "99999";
    luong.data["CamScanner_RoadMap"] = 100000;
}

if ($request.url.indexOf(vipb) != -1) {
    luong.data.ar_property = luong.data.ar_property || {};
    luong.data.ar_property["psnl_vip_property"] = vip;
}
